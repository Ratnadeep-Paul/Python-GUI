...
<head>
    ...
    <title>Fasion Is On-- <?php echo $gen ?>'s Fasion</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="Featured-Product">
        <h1 class="item-heading <?php echo $gen ?>-Watches"><?php echo $gen ?>'s Watches</h1>
    </div>

    <div class="container">
        <?php
        $sql = "SELECT * FROM `Watches` ORDER BY `S.no` DESC";
